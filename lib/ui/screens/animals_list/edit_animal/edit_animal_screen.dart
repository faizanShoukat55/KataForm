...
import 'edit_animal_view_model.dart';
...
class EditAnimalScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => EditAnimalViewModel(animal),
      child: Consumer<EditAnimalViewModel>(
              ...
              child: Column(
                ...
                children: [
                  InkWell(
                    ...
                    child: (model.animal.animalImage != null &&
                            model.profileImage == null)
                        ? ImageContainer(
                            height: 100.h,
                            width: 390.w,
                            radius: 8.r,
                            url: model.animal.animalImage,
                            fit: BoxFit.fill,
                          )
                        : model.profileImage == null
                            ? DottedBorder(
                  ...
                  InputTextField(
                    ...
                    validation: (String? val) {
                      if (val!.isEmpty || val.length < 1) {
                        return "Please Enter Animal DOB";
                      } else {
                        return null;
                      }
                    },
                  ...
                  DropDownMenu(
                    selectedValue: model.animal.animalCategory,
                  ...
                  DropDownMenu(
                    selectedValue: model.animal.animalSex,
                    validator: (String? val) {
                      if (val == null || val.isEmpty) {
                  ...
                  Row(
                    ...
                    children: [
                      TextButton(
                        ...
                        child: Text(
                          "${model.advanceOption ? "Roll Up" : "See More"}",
                          style: poppinTextStyle.copyWith(
                            color: primaryColor,
                            fontSize: 15.sp,
                          ),
